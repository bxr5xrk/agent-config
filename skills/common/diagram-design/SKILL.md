---
name: diagram-design
description: Create complex explanatory or presentation-quality diagrams as standalone HTML/SVG/PNG when polished visual structure materially improves understanding. Use for multi-step processes, architecture, sequence, state, data flow, comparisons, timelines, swimlanes, charts, technical models, or dense relationships; redraw Draw.io, Mermaid, or Excalidraw sources; apply brand tokens, semantic patterns, annotations, motion, or sketchy styling. Do not use for simple diagrams with only a few blocks; use built-in diagramming instead.
license: MIT
metadata:
  version: "2.6"
---
